...
# setting hal.stderr is jtag_uart2
ELF_PATCH_FLAG  += --stderr_dev jtag_uart2

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart2
ELF_PATCH_FLAG  += --stdin_dev jtag_uart2
...
# setting hal.stdout is jtag_uart2
ELF_PATCH_FLAG  += --stdout_dev jtag_uart2
