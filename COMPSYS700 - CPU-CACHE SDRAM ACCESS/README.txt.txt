...
-> Begin by navigating to the COMPSYS700 - CPU-CACHE SDRAM ACCESS folder and opening the TransactionsBetweenCPU.qpf file
...
->Once open, Navigate to the COMPSYS700 - CPU-CACHE SDRAM ACCESS folder and compile the following vhd files.
	->cpu0
	->sdram
	->transactionsBetweenCPU
	->testbench
->All should compile without error, once compiled right click testbench->Simulate
->In the instances there should be a drop down called b2v_inst, click the Plus and you should be seeing b2v_inst and b2v_inst3
->Click the b2v_inst, this will be corresponding to the cpu.
...
->The program should show you basic transactions between a CPU's cache and SDRAM