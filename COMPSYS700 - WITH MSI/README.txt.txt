...
-> Begin by navigating to the COMPSYS700 - WITH MSI folder and opening the TransactionsBetweenCPU.qpf file
...
->Once open, Navigate to the COMPSYS700 - WITH MSI and compile the following vhd files.
	->cpu0
	->sdram
...
->The signals that we care about are
	...
	->cpu_rd_req_in
	->cpu_wr_req_in
	->cache_to_cache_req_out
	->cache_to_cache_req_in
	->cache_to_cache_resp_in_data
	->cache_to_cache_resp_in_addr
	->cache_to_cache_resp_out_data
	->cache_to_cache_resp_out_addr
	->wantedAddressLatch
	->cache
	->hit
	->CurrentState
