...
vcom -93 -work cycloneive {c:/intelfpga_lite/18.1/quartus/eda/sim_lib/cycloneive_atoms.vhd}
vcom -93 -work cycloneive {c:/intelfpga_lite/18.1/quartus/eda/sim_lib/cycloneive_components.vhd}
...
vcom -93 -work work {C:/COMPSYS700 - CPU-CACHE SDRAM ACCESS/cpu0.vhd}
vcom -93 -work work {C:/COMPSYS700 - CPU-CACHE SDRAM ACCESS/sdram.vhd}
