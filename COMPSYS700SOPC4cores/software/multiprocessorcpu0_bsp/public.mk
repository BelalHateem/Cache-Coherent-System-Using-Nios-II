...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../top.sopcinfo
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1728814527
SOPC_SYSID_FLAG += --timestamp=1728814527
ELF_PATCH_FLAG  += --timestamp 1728814527
...
# setting hal.stderr is jtag_uart0
ELF_PATCH_FLAG  += --stderr_dev jtag_uart0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart0
ELF_PATCH_FLAG  += --stdin_dev jtag_uart0
...
# setting hal.stdout is jtag_uart0
ELF_PATCH_FLAG  += --stdout_dev jtag_uart0
